...
RegisterNetEvent('dj_baspel:createMusicMenu', function()
    lib.registerContext({
        ...
        },
        {
            ...
            options = {
                {
                    title = Config.Playlist['1'],
                    args = {music = Config.Playlist['music_1_id']},
                    event = 'dj_baspel:playMusicFromPlaylist'
                },
                {
                    title = Config.Playlist['2'],
                    args = {music = Config.Playlist['music_2_id']},
                    event = 'dj_baspel:playMusicFromPlaylist'
                },
                {
                    title = Config.Playlist['3'],
                    args = {music = Config.Playlist['music_3_id']},
                    event = 'dj_baspel:playMusicFromPlaylist'
                },
                {
                    title = Config.Playlist['4'],
                    args = {music = Config.Playlist['music_4_id']},
                    event = 'dj_baspel:playMusicFromPlaylist'
                },
                {
                    title = Config.Playlist['5'],
                    args = {music = Config.Playlist['music_5_id']},
                    event = 'dj_baspel:playMusicFromPlaylist'
                },
                {
                    title = Config.Playlist['6'],
                    args = {music = Config.Playlist['music_6_id']},
                    event = 'dj_baspel:playMusicFromPlaylist'
                },
                {
                    title = Config.Playlist['7'],
                    args = {music = Config.Playlist['music_7_id']},
                    event = 'dj_baspel:playMusicFromPlaylist'
                },
                --{
                --    title = Config.Playlist['full'],
                --    args = {music = Config.Playlist['music_full_id']},
                --    event = 'dj_baspel:playMusicFromPlaylist'
                --},
            }
        }
